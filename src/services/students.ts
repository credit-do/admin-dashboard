...
export const createStudent = async (classId: string, studentInput: StudentInput) => {
    ...
    .catch((error) => {
        ...
        studentInput.firstName + studentInput.lastInitial + "@" + studentInput.parentEmail.split('@')[1];
    ...
    const sendEmail = sendPermissionEmail(studentInput.firstName, studentInput.parentEmail);
